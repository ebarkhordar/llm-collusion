...
from _paths import CONFIG, PROMPTS, data_dir as resolve_data_dir
...
def execute(
    ...
    paths = cfg.get("paths", {})
    data_dir = resolve_data_dir(paths.get("data_dir"))
    code_generation_dir = data_dir / "code_generation"
    ...
    prompt_path = Path(prompt_file) if prompt_file else PROMPTS / "model_attribution" / "self_recognition_pair.md"
